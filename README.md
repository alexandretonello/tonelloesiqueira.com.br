...
> **Sobre o `.nojekyll`:** é um arquivo vazio (0 bytes) e começa com ponto, por isso
> o Finder (Mac) e o Explorer (Windows) o escondem por padrão. No Mac, use
> **Cmd + Shift + .** para exibi-lo. Ele só precisa existir — não tem conteúdo.
...
O DNS (registros A do GitHub Pages e roteamento) é gerenciado via **Cloudflare**.
...
Todo o site está em um único arquivo `index.html` (estilos e scripts inclusos).
Basta editar esse arquivo e enviar (commit) a nova versão para o repositório;
o GitHub Pages publica a atualização em cerca de 1 minuto.

---

© 2026 Tonello & Siqueira · Brasil
